      ...
      Row(
        ...
        children: [
          ...
          TextButton(
            ...
            onPressed: () => showDialog(context: context, builder: (context) => confirmDeleteUserDataDialog(context))
          )
        ],
      )
...
Dialog confirmDeleteUserDataDialog(BuildContext context) {
  ...
  Column dialogContent = Column(
    ...
    children: [
      ...
      const Gap(20),
      Text(
        "This is your last chance to back out. Are you sure you want to permanently delete your data? All your notes and data will be lost forever.",
        textAlign: TextAlign.center,
      ),
      const Gap(8),
      Text(
